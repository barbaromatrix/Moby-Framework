...
class ConsoleRequest implements InterfaceConsole
{
    ...
    {
        if (!ConsoleRequest::$arguments[2])
            return false;
            
        return fopen('App/Http/Requests/'.ucwords(ConsoleRequest::$arguments[2].'.php'), 'w');
    }
    ...
    {
        $template = str_replace('[#class#]', ucwords(ConsoleRequest::$arguments[2]), $template);
    ...
    public static function getSuccessComand()
    {
        return "Moby Framework \n \n"
                ."Request ".ConsoleRequest::$arguments[2]." successfully Consoled";
    }
